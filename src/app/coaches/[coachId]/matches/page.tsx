...
export default async function CoachMatchesPage({
  ...
  return (
    <div className="space-y-6">
      <Link href={`/coaches/${idNum}`} className="text-sm text-muted hover:text-accent transition-colors inline-flex items-center gap-1.5">
      ...
      <h1 className="text-2xl font-bold text-white">All Matches Coached by {profile.name}</h1>
